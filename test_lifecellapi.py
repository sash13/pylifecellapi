...
class LifecellApiTest(unittest.TestCase):
  def setUp(self):
    ...
    self.req = { 'accessKeyCode': self.api.settings['access_key_code'], 'msisdn': self.api.num, 'superPassword': self.api.pwd}

  def testSignedUrl(self):
    answer = self.api.createSignedUrl('signIn', self.req)
  ...
  def testRequest(self):
    answer = self.api.request('signIn', self.req)
